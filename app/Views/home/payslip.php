                    ...
                    <table class="border-collapse w-full">
                        ...
                        <tr>
                            ...
                            <td class="flex items-center justify-between font-mono">
                                ...
                                <div><?=CURRENCY_NAIRA . number_format($allowance_records['entertainment'] == NULL || $allowance_records['entertainment'] == 0 ? '0.00' : (float)$allowance_records['entertainment'])?></div>
                            </td>
                            <td class="flex items-center justify-between font-mono">
                                <div>Medical</div>
                                <div>0.00</div>
