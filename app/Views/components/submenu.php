...
<div id="LeftSidebar" class="lg:flex flex-col hidden w-1/5 mt-0 lg:mt-10">
    <nav role="nav">
        <ul class="flex w-full flex-col">
            <li class="<?=$uri->getSegment(1) == 'deductions' ? 'bg-white rounded-l-md hover:bg-gray-50 shadow-lg' : 'bg-gray-50 opacity-30 hover:opacity-50'?>">
                <a href="#" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 text-gray-500 text-sm font-sans font-regular">
                    <span>
            ...
            <li class="<?=$uri->getSegment(1) == 'accounts' ? 'bg-white rounded-l-md hover:bg-gray-50 shadow-lg' : 'bg-gray-50 opacity-30 hover:opacity-50'?>">
                <a href="#" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 text-gray-500 text-sm font-sans font-regular">
                    <span>
                        <ion-icon name="wallet-outline"></ion-icon>
                    </span>
