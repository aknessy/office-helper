    ...
    <nav role="nav">
        <ul class="flex w-full flex-col">
            <li class="<?=$uri->getSegment(1) == 'payslip' ? 'bg-white pointer-event-none' : 'hover:opacity-50'?>">
                <a href="<?=base_url('payslip')?>" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 <?=$uri->getSegment(1) == 'payslip' ? 'text-gray-500' : 'text-white'?> text-sm font-sans font-regular">
                    <span>
            ...
            <li class="<?=$uri->getSegment(1) == 'deductions' ? 'bg-white pointer-event-none' : 'hover:opacity-50'?>">
                <a href="<?=base_url('deductions')?>" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 <?=$uri->getSegment(1) == 'deductions' ? 'text-gray-500' : 'text-white'?> text-sm font-sans font-regular">
                    <span>
            ...
            <li class="<?=$uri->getSegment(1) == 'accounts' ? 'bg-white' : 'hover:opacity-50'?>">
                <a href="<?=base_url('accounts')?>" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 <?=$uri->getSegment(1) == 'accounts' ? 'text-gray-500' : 'text-white'?> text-sm font-sans font-regular">
                    <span>
                        <ion-icon name="wallet-outline"></ion-icon>
                    </span>
                    <span>Account</span>
            ...
            <li class="<?=$uri->getSegment(1) == 'allowances' ? 'bg-white' : 'hover:opacity-50'?>">
                <a href="<?=base_url('allowances')?>" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 <?=$uri->getSegment(1) == 'allowances' ? 'text-gray-500' : 'text-white'?> text-sm font-sans font-regular">
                    <span>
                        <ion-icon name="heart-half-outline"></ion-icon>
                    </span>
            ...
            <li class="<?=$uri->getSegment(1) == 'cpssheet' ? 'bg-white' : 'hover:opacity-50'?>">
                <a href="#" class="w-full inline-flex items-center justify-start space-x-2 py-3 px-2 <?=$uri->getSegment(1) == 'cpssheet' ? 'text-gray-500' : 'text-white'?> text-sm font-sans font-regular">
                    <span>
                        <ion-icon name="document-text-outline"></ion-icon>
                    </span>
