    ...
    **/
    ...
    public function search(){
        ...
        if(isset($search_term)){
            ...
            $second_query = $this->staff->where('staff_name', esc($search_term))->findAll();
            ...
            elseif($second_query){
                ...
                return json_encode(['Message':'Your search term returned 0 re'])
            }
