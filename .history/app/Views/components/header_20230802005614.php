...
<body class="bg-slate-200 ">
  <div class="w-full h-screen mt-7">
    <div class="flex flex-col lg:w-2/3 md:w-1/2 mx-auto py-4 space-y-4">
        ...
        <?php }else{?>
            <div class="flex flex-col w-full mb-6 mt-0 space-x-3">
                <div class=" bg-red-300 flex space-x-3 mb-4 items-center justify-start shadow-sm">
                    <span class="h-full p-4 items-center justify-center font-sans text-2xl text-red-600">
                        <i data-feather="alert-octagon"></i>
                    </span>
                    <p class="text-red-7600 text-sm font-sans leading-tight antialiased text-left m-0"><?=session()->getFlashdata('error')</p>
                </div>
            </div>
        <?php } ?>