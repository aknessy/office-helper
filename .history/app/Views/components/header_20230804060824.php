            ...
            <div class="w-full lg:w-1/2 flex items-center justify-end">
                <nav role="navigation">
                    <ol aria-label="menu" class="flex">
                        ...
                        <li class="relative">
                            <button class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 s hover:text-gray-500 hover:bg-blue-50" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                <span>Options</span>
