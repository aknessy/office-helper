                                    ...
                                    <div class="py-1" role="none">
                                        <?php if($this->request->uri->getSegment()){
                                            ...
                                            <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                                <a href="<?=base_url('home/manually')?>" class="<?=$this->request->uri->getSegment(2) == 'manually' ? 'border-s-2 border-l-blue-200' : ''?> text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Generate Manually</a>
                                        <?php if($uri->segMent(1)){ ?>
                                            <a href="<?=base_url()?>" class="<?=($uri->getSegment(1) == 'home' || $uri->getSegment(1) == null) ? 'border-s-2 border-l-blue-200' : ''?> text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Automated Payslip</a>
                                            <?php }else{ ?>
