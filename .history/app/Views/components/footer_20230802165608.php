        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(targetEl).on('blur', function(){
                    ...
                    if(searchTerms !== ''){
                        if($(noResultContainer).hasClass('hidden'))
                            $(noResultContainer).removeClass('hidden').addClass('flex')
                            $(resultContainer).removeClass('items-center hidden').addClass('flex')
                        }else{
                            $(noResultContainer).addClass('hidden').removeClass('flex')
                            $(resultContainer).removeClass('flex').addClass('items-center hidden')
                        }
