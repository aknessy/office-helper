            ...
            <div class="w-full lg:w-1/2 flex items-center justify-end">
                <nav role="navigation">
                    <ol aria-label="menu" class="flex items-center">
                        <li class="mr-4">
                            <a href="#" class="text-xs text-gray-400 hover:text-gray-700 hover:underline flex flex-row font-semibold space-x-1 items-center px-3 py-2">
                        ...
                        <li>
                            <div class="relative inline-block text-left">
                                <button class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-blue-50 hover:bg-white focus:bg-white px-3 py-2 text-xs font-semibold text-gray-00 hover:text-gray-700 focus:text-gray-700 shadow-sm ring-1 ring-gray-600 ring-opacity-5 hover:transition-all" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                    <span>Options</span>
