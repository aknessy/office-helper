...
<body class="bg-slate-200 ">
  <div class="w-full h-screen mt-12">
    <div class="flex flex-col lg:w-2/3 md:w-1/2 mx-auto py-4 space-y-4">
        <div class="w-full flex lg:flex-row items-center lg:justify-between pb-10 mb-5">
            ...
            <div class="w-full lg:w-1/2">
                <nav aria-label="breadcrumb">
                     <ol class="flex w-full flex-wrap items-center justify-end rounded-md bg-blue-gray-50 bg-opacity-60 py-2 px-4">
                    <?php
                        if($breadcrumbs):
                            foreach ($breadcrumbs as $key => $menu):
                                ...
                                if ($key == 0 && NULL !== $menu):
                                    echo "<a href='" . base_url('/') . "' class='opacity-60'>"; echo "<span class='flex items-center justify-start space-x-3'><i data-feather='home' class='m-0 h-4 w-4'></i> Home</span>";

                                    echo "</a>";
                                elseif ($key == 0 && NULL == $menu):
                                    echo "<a href='" . base_url('/') . "' class='opacity-60 flex space-x-2 text-xs'>"; 
                                    echo "<span class='flex items-center justify-start space-x-3'><i data-feather='home' class='m-0 h-4 w-4'></i> Home</span>";
                                    echo "</a>";  
                                else:
