                        ...
                        <l class="mr-4">
                            <a href="#" class="text-xs text-gray-400 hover:text-gray-500 hover:underline flex flex-row space-x-1 items-center">
                                <span class="p-1 rounded bg-blue-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download">
