                ...
                <nav role="navigation">
                    <ol aria-label="menu" class="flex">
                        ...
                        <li>
                            ...
                            <div class="absolute left-0 z-10 mt-2 w-auto origin-top-ri rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
