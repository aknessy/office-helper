                    ...
                    <ol aria-label="menu" class="flex items-center">
                        ...
                        <li>
                            <div class="relative inline-block text-left">
                                <button class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-blue-50 hover:bg-white focus:bg-white px-3 py-2 text-xs font-semibold text-gray-400 hover:text-gray-600 focus:text-gray-700 shadow-sm ring-1 ring-gray-600 ring-opacity-5 hover:transition-all" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                    <span>Options</span>
                                    <svg class="-mr-1 h-5 w-5 viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                                <div class="absolute tight-0 z-10 mt-2 w-52 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        <?php if($this->request->uri->getSegment()){
                                            if($this->request->uri->getSegment(2) == 'manually'){ ?>
                                            <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                                <a href="<?=base_url('home/manually')?>" class="border-s-2 border-l-blue-200 text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Generate Manually</a>
                                        ...
                                        <?php } 
                                            ...
                                            <a href="<?=base_url('home/manually')?>" class="text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Generate Manually</a>  
                                            <a href="<?=base_url()?>" class="text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Automated Payslip</a><?php } ?>
