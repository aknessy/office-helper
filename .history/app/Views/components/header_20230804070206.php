                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div class="absolute tight-0 z-10 mt-2 w-52 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    ...
                                    <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                        <a href="<?=base_url('home/manually')?>" class="<?=$uri-text-gray-400 hover:text-gray-600 hover:bg-blue-50 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Generate Manually</a>
