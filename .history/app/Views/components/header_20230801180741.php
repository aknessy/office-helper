    ...
    <div class="flex flex-col lg:w-2/3 md:w-1/2 mx-auto py-4 space-y-4">
        ...
        <div class="flex flex-col w-full mb-6 mt-0 space-x-3">
            <div class="bg-blue-200 flex space-x-3 mb-4 items-center justify-start">
                ...
                <p class="text-gray-700 text-sm font-sans leading-tight antialiased text-left">This appl to facilitate easy creation of payslips, but i have envisioned a scenario where this basic functionality will metamorphosed into something more fun</p>
            </div>
        </div>
