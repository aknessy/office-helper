    ...
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        <div class="flex flex-wrap mb-3">
            <div class="w-full md:w-1/3 px-3 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-2 px-2 leading-tight focus:outline-none focus:bg-white" id="grid-month" type="text"  name="firstname" placeholder="Jane">
