...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full gap-x-0">
        ...
        <div class="relative flex text-left">
            <input id="paySlipDate" class="datepicker-widget-ym overflow-auto text-gray-400 bg-white text-base py-1 px-3 ring-1  ring-gray-300 focus:outline-none sm:text-sm" />
        </div> 
        <div>
