<?php
    ...
    <div class="flex flex-col w-full p-4">
        ...
        <table class="table table-fixed w-full border border-gray-600">
            ...
            <tr>
                <td colspan="3" class="flex w-full flex-wrap items-center justify-between font-semibold text-gray-600 italic text-lg">
                    <div>Total Earnings= </div>
                    <div>0.00</div>
                </td>
                <td colspan="3" class="w-full flex flex-wrap items-center justify-between font-semibold text-gray-600 italic text-lg">
                    <div>Total Deductions= </div>
                    <div>0.00</div>
                </td>
            </tr>
            <tr>
                <td colspan="6" class="text-center p-4 font-bold text-2xl font-sans">
