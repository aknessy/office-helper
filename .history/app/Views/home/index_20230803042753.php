...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full space-x-1">
        <div>
            <input  id="searchQuery" class="appearance-none font-semibold border border-gray-300 focus:border-gray-400 focus:shadow-sm rounded-sm w-full py-3 px-2 text-gray-500 text-xs leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Staff name/file no. (e.g P.123)">
        </div>
        ...
        <div>
            <button class="inline-flex gap-x-1 bg-blue-400 text-sm text-white rounded-r-sm ring-1 ring-gray-400 px-2 py-2 items-center">
                <i data-feather="search" class="font-semibold font-sans text-sm"></i>
                <span class="text-sm font-semibold font-sans">Find Staff</span>
            </button>
        </div>
    </div>
    <div class="flex flex-row w-1/2 align-items-center justify-end space-x-4">
        ...
        <a id="advancedSearch" href="<?=base_url('home/advanced')?>" class="bg-blue-400 hover:bg-blue-500 text-sm font-sans py-2 px-2 rounded-md">Advanced Search</a>
    </div>
</div>
