    ...
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        <div class="flex flex-wrap mb-3">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <select class="appearance-none block w-full bg-gray-200 text-bgray-700 border border-gray-200 rounded py-2 px-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-year" type="text" name="month">
