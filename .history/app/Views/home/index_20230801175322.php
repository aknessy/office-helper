<div class="flex flex-col w-full mb-6 p-3 bg-blue-200 space-x-3">
    <div class="flex space-x-3 mb-4">
        ...
        <p class="text-gray-400 text-sm">The main idea was to facilitate easy creation of payslips, but i have envisioned a scenario where this basic functionality will metamorphosed into something more fun</p>
    </div>
</div>
