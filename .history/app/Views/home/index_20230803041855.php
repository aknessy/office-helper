...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full spac-x-2">
        <div>
        ...
        <div>
            <button class="inline-flex gap-x-1 bg-white text-sm text-gray-500 rounded-r-sm ring-1 ring-gray-400 px-2 py-2 items-center">
                <i data-feather="search" class="font-semibold text-gray-400"></i>
    ...
    <div class="flex flex-row w-1/2 align-items-center justify-end space-x-4">
        ...
        <a id="advancedSearch" href="<?=base_url('home/advanced')?>" class="bg-blue-400 hover:bg-blue-500 text-xs font-sans py-2 px-2 rounded-md">Advanced Search</a>
    </div>
</div>
