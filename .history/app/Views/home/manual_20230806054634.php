    ...
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        ...
        <div class="flex flex-wrap mb-8">
            <div class="w-full md:w-1/2 px-3 md:mb-0">
                ...
                <input class="datepicker-wiappearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-dob" type="text" name="dob" placeholder="yyyy/mm/dd">
            </div>
            <div class="w-full md:w-1/2 px-3 md:mb-0">
