...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full space-x-1 sm:space-x-0">
        ...
        <div class="relative flex text-left">
            <select class="overflow-auto text-gray-400 bg-white text-base py-1 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                <option value="">Select Year</option>
            </select>
        </div> 
        <div>
            <button id="submitQuery" class="inline-flex gap-x-1 bg-blue-400 hover:bg-blue-500 text-sm text-white rounded-r-sm ring-1 ring-gray-400 px-2 py-2 items-center">
...
<div class="w-full flex h-96 justify-center bg-zinc-100 rounded-lg pt-6">
    ...
    <div id="recordsContainer" class="flex flex-col h-full w-full items-center justify-center space-y-2 hidden">
