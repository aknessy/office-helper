<?php
    ...
    <div class="flex flex-col w-full p-4">
        ...
        <table class="table table-fixed w-full border border-gray-600">
            ...
            <tr>
                <td colspan="3" class="text-center font-semibold text-gray-600 italic text-2xl">Total Earnings = 0.00</td>
                <td colspan="3" class="text-center font-semibold text-gray-500 italic text-2xl">Total Deductions = 0.00</td>
            </tr>
            <tr>
