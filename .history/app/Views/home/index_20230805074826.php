...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row flex-wrap w-full gap-x-0">
        <div class="inline-flex bg-white border border-gray-300 p-1">
            <div>
                <input  id="searchQuery" class="appearance-none font-semibold border border-none text-xs focus:border-none w-full py-1 px-3 text-gray-500 leading-tight focus:outline-none" type="text" placeholder="Staff name/file no. (e.g P.123)">
            </div>
            <div class="relative flex text-left border border-l">
                <input id="paySlipDate" class="datepicker-widget-ym appearance-none font-semibold text-gray-400 bg-white text-xs py-1 px-3 border-none focus:outline-none leading-tight" type="text placeholder="Year & Month" />
            </div>
        </div> 
        <div>
