    ...
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        ...
        <div class="flex flex-wrap mb-3">
            <div class="relative h-10 w-full">
                ...
                <iclass="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-red-500 focus:border-2 focus:border-blue-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            </div>
        </div>
        <div class="flex flex-wrap mb-3">
