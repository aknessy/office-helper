<?php
    ...
    ?>
    <div class="flex items-center justify-end p-2 mb-2">
        <button onclick="printDiv('printArea')" class="inline-flex bg-blue-300 outline outline-offset-0 border border-blue-400 text-white text-sm">
    ...
    <div class="flex items-center justify-end p-2 mt-2 w-full">
        <button onclick="printDiv('printArea')" class="inline-flex bg-blue-300 border border-blue-400 text-white text-2xl">
            <i data-feather="print"></i>
            <span>Print</span>
        </button>
    </div>
