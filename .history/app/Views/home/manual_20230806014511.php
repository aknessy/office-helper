...
<form action="" method="post" class="w-full">
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        ...
        <div class="flex flex-wrap justify-between w-full px-3 mb-4">
            ...
            <button type="submit" class="w-full md:w-1/2 bg-blue-400 hover:bg-blue-500 font-semibold text-white hover:text-dark font-sans py-2 px-4 rounded-md">Advanced Search</button>
        </div>
    </div>
</form>