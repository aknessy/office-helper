...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full">
        ...
        <div class="relative flex text-left">
            <div>
                <button type="button" class="inline-flex w-full justify-center gap-x-1.5 bg-white px-3 py-2 text-sm text-gray-600 shadow-sm ri hover:bg-gray-50" id="menu-button" aria-expanded="true" aria-haspopup="true">
                Options
