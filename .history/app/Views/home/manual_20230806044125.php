        ...
        <div class="flex flex-wrap mb-3">
            <div class="w-full md:w-1/2 px-3 md:mb-0">
                <div class="relative h-10 w-72 min-w-[200px]">
                    <select class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200  focus:border-2 focus:border-blue-400 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                        <option value="">Select Month</option>

                        <?php foreach(MONTH_WITH_NAMES as $num => $name){?>
                            <option value="<?=$num?>"><?=$ucwords(strtolower($name)) . '-' . $key?>
                            <?php } ?>
                    </select>
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <select class="appearance-none block w-full bg-gray-200 text-blue-gray-700 border border-gray-200 rounded py-2 px-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-year" type="text" name="month">
