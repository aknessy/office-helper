...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full gap-x-0">
        <div>
            <input  id="searchQuery" class="appearance-none font-semibold border border-none text-base focus:border-none w-full py-2.5 px-3 text-gray-500 text-xs leading-tight focus:outline-none" type="text" placeholder="Staff name/file no. (e.g P.123)">
        </div>
        <div class="relative flex text-left">
            <input id="paySlipDate" class="datepicker-widget-ym appearance-none font-semibold text-gray-400 bg-white text-base py-2.5 px-3 ring-1 border-none ring-gray-300 focus:outline-none" placeholder="Pick a date (Year & Month)" />
        </div> 
        <div>
