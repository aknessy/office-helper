...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full">
        ...
        <div class="relative flex text-left">
            <select class="overflow-auto rounded-md bg-white text-base py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                <option value="">Select Year</sel
            </select>
        </div> 
    </div>
