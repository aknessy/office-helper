<div class="flex flex-col w-full mb-6 mt-0 p-3 space-x-3">
    <div class="bg-blue-200 flex space-x-3 mb-4 items-center justify-start">
        <span class="h-full p-4 items-center justify-center font-sans text-2xl text-gray-70">
            <i data-feather="alert-octagon"></i>
        </span>
        <p class="text-gray-700 text-sm font-sans leading-tight antialiased text-left">The main idea was to facilitate easy creation of payslips, but i have envisioned a scenario where this basic functionality will metamorphosed into something more fun</p>
    </div>
</div>
