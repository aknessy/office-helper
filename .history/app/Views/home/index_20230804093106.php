...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full gap-x-0">
        <div>
            <input  id="searchQuery" class="appearance-none font-semibold border border-gray-300 ring-1 ring-gray-100 focus:border-gray-400 focus:shadow-sm rounded-sm w-full py-2.5 px-3 text-gray-500 text-xs leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Staff name/file no. (e.g P.123)">
        </div>
        <div class="relative flex text-left">
            <select class="overflow-auto text-gray-400 bg-white text-base py-1 ring-1 ring-gray-2300 focus:outline-none sm:text-sm">
