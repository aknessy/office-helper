<div class="flex flex-col w-full mb-6 mt-0 p-3 bg-blue-300 space-x-3">
    <div class="flex space-x-3 mb-4 items-center justify-start">
        ...
        <p class="text-gray-4 text-sm font-sans leading-tight antialiased text-left">The main idea was to facilitate easy creation of payslips, but i have envisioned a scenario where this basic functionality will metamorphosed into something more fun</p>
    </div>
</div>
