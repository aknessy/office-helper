<?php
    ...
    <div class="flex flex-col w-full p-4">
        ...
        <p class="text-center text-sm italic mt-4 mb-2 text-gray-500">Pay Slip For <?=date('Y') .', ' . date('M')?></p>
        <table class="table table-fixed w-full border border-gray-600">
            <tr>
                <td class="font-semibold text-sm">Staff File No.:</td>
                <td class="italic">INEC/CRS/<?=ucfirst($result['file_no'])?></td>
                <td class="font-semibold">Name:</td>
                <td class="italic"><?=strtoupper($result['staff_name'])?></td>
                <td class="font-semibold">Pay Point:</td>
                <td class="italic">
                    <span><?=strtoupper($account_records->bank_name)?></span>&nbsp;(<?=$account_records->bank_code?>)
            ...
            <tr>
                <td colspan="3" class="flex flex-wrap items-center justify-between font-semibold text-gray-600 italic text-2xl">
                    <div>Total Earnings= 0.00</td>
                <td colspan="3" class="flex flex-wrap items-center justify-between font-semibold text-gray-600 italic text-2xl">Total Deductions= 0.00</td>
            </tr>
            <tr>
                <td colspan="6" class="text-center p-4 font-bold text-3xl font-sans">
                    <p class="text-gray-700">Net Pay= 0.00</p>
                </td>
            </tr>
        </table>
    </div>
