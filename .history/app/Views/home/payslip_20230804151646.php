    ...
    <div class="flex flex-col w-full p-4">
        ...
        <table class="table table-fixed w-full border border-gray-600">
            ...
            <tr class="pt-5 pb-5 border border-gray-600">
                <td colspan="2" class="border border-gray-600 font-semibold">EARNINGS</td>
                <td colspan="2" class="border border-gray-600 font-semibold">DEDUCTIONS</td>
                <td colspan="2" class="border border-gray-600 font-semibold">TAX INFORMATION</td>
            </tr>
        </table>
    </div>
    <?php }
