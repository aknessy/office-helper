        ...
        <div class="flex flex-wrap mb-3">
            <div class="w-full md:w-1/2 px-3 md:mb-0">
                <div class="relative h-10 w-72 min-w-[200px]">
                    <select class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 focus:border-2 focus:border-blue-400 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                        <option value="">Select Month</option>

                        <?php foreach(MONTH_WITH_NAMES as $num => $name){?>
                            <option value="<?=$num?>">ucwo<?=$ucwords(strtolower($name)) . '-' . $key?>
                            <?php } ?>
                    </select>
