...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full lg:gap-x-1 gap-x-0">
        ...
        <div>
            <button id="submitQuery" class="inline-flex gap-x-1 bg-blue-400 hover:bg-blue-500 text-sm text-white rounded-r-sm ring-1 ring-gray-400 ring-opaci px-2 py-2 items-center">
