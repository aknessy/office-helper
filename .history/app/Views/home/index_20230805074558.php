    ...
    <div class="flex flex-row flex-wrap w-full gap-x-0">
        <div class="inline-flex bg-white border border-gray-300 p-1">
            ...
            <div class="relative flex text-left border border-l">
                <input id="paySlipDate" class="datepicker-widget-ym appearance-none font-semibold text-gray-400 bg-white text-xs py-1 px-3 border-none focus:outline-none focus:outline" placeholder="Pick a date (Year & Month)" />
            </div>
        </div> 
        <div>
