...
<div class="w-full flex flex-row items-center justify-between">
    ...
    <div class="flex flex-row w-1/2 align-items-center justify-end space-x-4">
        ...
        <a id="advancedSearch" href="<?=base_url('home/search-history')?>" class="inline-flex space-x-2 items-center justify-center ring-1 ring-gray-600 ring-opacity-5 bg-blue-50 hover:bg-white hover:text text-xs font-sans py-2.5 px-2 rounded-md">
