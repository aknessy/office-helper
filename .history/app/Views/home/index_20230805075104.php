...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row flex-wrap w-full gap-x-0">
        ...
        <div>
            <button id="submitQuery" class="inline-flex gap-x-1 bg-blue-400 hover:bg-blue-500 text-sm text-white rounded-r- ring-1 ring-blue-500 px-3 py-2 items-center">
