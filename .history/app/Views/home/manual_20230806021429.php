    ...
    <div class="bg-white w-full rounded-lg mb-6 py-3 px-3">
        ...
        <div class="flex flex-wrap mb-3">
            <div class="w-full px-3">
                ...
                <input class="appearance-none block border rounded bg-gray-200 w-full py-2 px-2 text-blugray-700 text-sm font-italic font-light leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-file-no" name="file_num" type="text" placeholder="File no.">
            </div>
        </div>
        <div class="flex flex-wrap mb-3">
