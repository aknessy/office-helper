...
<div class="w-full flex h-96 justify-center bg-zinc-100 rounded-lg pt-6">
    ...
    <div id="recordsContainer" class="flex-col h-full w-full items-center justify-center space-y-2 flex hidden"></div>
</div>

<?php echo ('../fragments/service-worker.fragments.html') ?>