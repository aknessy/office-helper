...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row flex-wrap w-full gap-x-0">
        <div class="inline-flex bg-white border border-gray-300 p-1">
            <div>
                <input  id="searchQuery" class="appearance-none font-semibold border border-none text-xs focus:border-none w-full py-1 px-3 text-gray-500 leading-tight focus:outline-none focus:outline-offs" type="text" placeholder="Staff name/file no. (e.g P.123)">
            </div>
