...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full space-x-1 sm:space-x-0">
        <div>
            <input  id="searchQuery" class="appearance-none font-semibold border border-gray-300 focus:border-gray-400 focus:shadow-sm rounded-sm w-full py-2.5 px- text-gray-500 text-xs leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Staff name/file no. (e.g P.123)">
        </div>
