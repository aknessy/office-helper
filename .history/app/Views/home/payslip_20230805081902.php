<?php
    ...
    ?>
    <div class="flex flex-row flex-wrap items-center justify-end p-2 mb-2">
        <div></div>
    ...
    <div class="flex flex-row flex-wrap items-center justify-end p-2 mt-2 w-full">
        <div></div>
        <button onclick="printDiv('printArea')" class="inline-flex bg-blue-300 border border-blue-400 text-white text-2xl space-x">
            <i data-feather="printer"></i>
            <span>Print</span>
        </button>
    </div>
