                ...
                <td colspan="2" class="border border-gray-600">
                    <table class="border-collapse w-full">
                        ...
                        <tr>
                            ...
                            <td class="flex items-center justify-between font-mono">
                                <div>Domestic Allow.:</div>
                                <div>0.00</div>
                            </td>
                            <td class="flex items-center justify-between font-mono">
                                <div>Personal Assist.:</div>
                                <div>0.00</div>
                            </td>
                            ...
                            <td class="flex items-center justify-between font-mono">
                                <div>Furniture Allow.:</div>
                                <div>0.00</div>
                            </td>
                            <td class="flex items-center justify-between font-mono">
                                <div>Entertainment Allow.:</div>
                                <div>0.00</div>
                            </td>
                            <td class="flex items-center justify-between font-mono">
                            ...
                            <td class="flex items-center justify-between font-mono">
                                <div>Hazard Allow.:</div>
                                <div>0.00</div>
                            </td>
                            <td class="flex items-center justify-between font-mono">
                                <div>Responsibility Allow.:</div>
                                <div>0.00</div>
                            </td>
                        </tr>
                    </table>
