    ...
    <div class="flex flex-row flex-wrap w-full gap-x-0">
        <div class="inline-flex bg-white border border-gray-300">
            ...
            <div class="relative flex text-left border-l">
                <input id="paySlipDate" class="datepicker-widget-ym appearance-none font-semibold text-gray-400 bg-white text-xs py- px-3 border-none focus:outline-none leading-tight" type="text placeholder="Year & Month" />
            </div>
        </div> 
        <div>
