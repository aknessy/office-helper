...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full space-x-1 sm:space-x-0">
        <div>
            <input  id="searchQuery" class="appearance-none font-semibold border border-gray-300 focus:border-gray-400 focus:shadow-sm rounded-sm w-full py-2.5 px-2 text-gray-500 text-xs leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Staff name/file no. (e.g P.123)">
        </div>
        <div class="relative flex text-left">
            <select class="overflow-auto text-gray-500 bg-white text-base py-1 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                <option value="">Select Year</option>
            </select>
        </div> 
        <div>
            <button class="inline-flex gap-x-1 bg-blue-400 hover:bg-blue-500 text-sm text-white rounded-r-sm ring-1 ring-gray-400 px-2 py-2 items-center">
    ...
    <div class="flex flex-row w-1/2 align-items-center justify-end space-x-4">
        <a id="searchHistory" href="" class="text-xs font-sans text-slate-600 hover:underline py-2.5 px-2">Search History</a>
        <a id="advancedSearch" href="<?=base_url('home/advanced')?>" class="bg-blue-50 hover:bg-blue-100 text-xs font-sans py-2.5 px-2 rounded-md">Advanced Search</a>
    </div>
</div>
