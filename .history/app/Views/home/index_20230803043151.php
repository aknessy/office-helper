...
<div class="w-full flex flex-row items-center justify-between">
    <div class="flex flex-row w-full lg:space-x-1">
        <div>
    ...
    <div class="flex flex-row w-1/2 align-items-center justify-end space-x-4">
        ...
        <a id="advancedSearch" href="<?=base_url('home/advanced')?>" class="bg-gray-500 hover:bg-blue-500 text-xs font-sans py-2.5 px-2 rounded-md">Advanced Search</a>
    </div>
</div>
